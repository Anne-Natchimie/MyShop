                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="">
                            ...
                            <td class="product-subtotal text-end">
                                <span class="amount text-color-dark font-weight-bold text-4">${{$itemCart->quantity * $itemCart->price}}</span>
                            </td>
                        </tr>
